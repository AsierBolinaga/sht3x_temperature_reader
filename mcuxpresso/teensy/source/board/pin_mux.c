...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B1_10_ENET2_1588_EVENT1_OUT,	/* GPIO_AD_B1_02 is configured as 1588_EVENT2_OUT */
  ...
  IOMUXC_SetPinMux(
      ...
      0U);   		                          /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
  	  IOMUXC_GPIO_AD_B0_02_LPUART6_TX,        /* GPIO_AD_B0_12 is configured as LPUART1_TX */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
  	  IOMUXC_GPIO_AD_B0_03_LPUART6_RX,        /* GPIO_AD_B0_13 is configured as LPUART1_RX */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
 ...
 IOMUXC_SetPinConfig(
    IOMUXC_GPIO_AD_B1_10_ENET2_1588_EVENT1_OUT,		/* GPIO_AD_B0_12 PAD functional properties : */
	0x10B0u);								/* Slew Rate Field: Slow Slew Rate
											   Drive Strength Field: R0/6
											   Speed Field: medium(100MHz)
											   Open Drain Enable Field: Open Drain Disabled
